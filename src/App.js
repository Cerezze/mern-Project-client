...
import PasswordRecreate from './Pages/passwordRecreate/passwordRecreate';
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path = "/recreatePassword" element = {authCtx.readyReset?<PasswordRecreate/>:<Navigate to = "/signLog"/>}/>
